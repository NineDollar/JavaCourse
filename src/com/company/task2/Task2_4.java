...
public class Task2_4 {
    ...
    public static class ComplexNumber {
        ...
        public ComplexNumber complexDiv(ComplexNumber value) {
            return new ComplexNumber((int) ((this.realPart * value.realPart + this.imagePart * value.imagePart) /
                    (Math.pow(value.realPart, 2) + Math.pow(value.imagePart, 2))),
                    (int) ((this.imagePart * value.imagePart - this.realPart * value.imagePart) / (Math.pow(value.realPart, 2) + Math.pow(value.imagePart, 2))));
